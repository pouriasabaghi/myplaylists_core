...
return [
    ...
    "telegram_login"=>"⚠️ Before continuing please pay attention:\nIf you already installed pwa version MyPlaylists we really recommend you to turn of In-App browser in Chat Settings tg://settings \n\n📲 To continue and log into your account, please click the button below. \n\n💡By clicking the button, you will be connected to your account. \n\n👇 Tap here to log in:",
    "login_button"=>"Login",
